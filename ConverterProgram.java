...
public class ConverterProgram implements ActionListener {
    // initiation of panels,frames,intput,fields,labels, and the MetricConverter
    // method.
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        // a switch for the selected conversion method from the combo box and executes
        // the method with
    ...
    private class MetricConverter {
        ...
        public MetricConverter() {
            ...
            mile = kilometer = feet = meter = milimeter = inch = centimeter = kph = mph = liter = gallon = pound = kilogram = fahrenheit = celsius = horsepower = kilowatt = 0;
        }
        ...
        // a method to convert metric celcius temperatures in degrees to standard
        // temperatures in fahrenheit in degrees.
        ...
        // a method to convert standard temperatures in fahrenheit in degrees to metric
        // celcius temperatures in degrees.
        ...
        // a method to convert the standard measure of power (horsepower) to the metric
        // measure of power (kilowatts).
        ...
        // a method to convert the metric measure of power(kilowatts) to the standard
        // measure of power(horsepower).
